...
ActiveRecord::Schema.define(version: 2023_03_04_140651) do

  create_table "account_book_types", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb3", force: :cascade do |t|
  ...
  create_table "account_number_rules", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb3", force: :cascade do |t|
    t.datetime "created_at"
    t.datetime "updated_at"
    t.string "name"
    t.string "rule_type"
  ...
  create_table "account_number_rules_users", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb3", force: :cascade do |t|
    t.integer "user_id"
    t.integer "account_number_rule_id"
    t.index ["account_number_rule_id"], name: "index_anru_account_number_rule_id"
    t.index ["user_id"], name: "index_anru_user_id"
  end

  create_table "account_sharings", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb3", force: :cascade do |t|
    t.integer "organization_id"
  ...
  create_table "accounting_plan_items", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb3", force: :cascade do |t|
    t.string "third_party_account"
    ...
    t.boolean "vat_not_recoverable", default: false
  ...
  create_table "accounting_plan_items_conterpart_accounts", id: false, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.integer "accounting_plan_item_id"
    t.integer "conterpart_account_id"
    t.index ["accounting_plan_item_id"], name: "index_ca_api_api_id"
    t.index ["conterpart_account_id"], name: "index_ca_api_ca_id"
  end

  create_table "accounting_plan_vat_accounts", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb3", force: :cascade do |t|
    t.string "code"
    t.string "nature"
    t.string "account_number"
  ...
  create_table "accounting_plans", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb3", force: :cascade do |t|
    t.datetime "created_at"
    t.datetime "updated_at"
    t.datetime "last_checked_at"
    t.integer "user_id"
    t.boolean "is_updating", default: false
    t.string "general_account_providers"
    t.string "general_account_customers"
    t.index ["user_id"], name: "user_id"
  end
  ...
  create_table "analytic_references", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1", force: :cascade do |t|
    t.string "a1_name"
  ...
  create_table "api_tokens", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci", force: :cascade do |t|
  ...
  create_table "archive_already_exist", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci", force: :cascade do |t|
  ...
  create_table "archive_invoices", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.string "name"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  end
  ...
  create_table "bank_accounts", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb3", force: :cascade do |t|
    t.datetime "created_at"
    t.datetime "updated_at"
    t.string "bank_name"
    t.string "name"
    ...
    t.integer "permitted_late_days", default: 7
    t.date "ebics_enabled_starting"
    t.string "cedricom_mandate_identifier"
    t.string "bic"
    t.string "currency_iso_code"
    t.string "cedricom_mandate_state"
    t.string "jedeclare_mandate_identifier"
    t.string "jedeclare_mandate_state"
    t.index ["cedricom_mandate_identifier"], name: "index_bank_accounts_on_cedricom_mandate_identifier"
    t.index ["retriever_id"], name: "retriever_id"
    t.index ["user_id"], name: "user_id"
  end

  create_table "billing_simulations", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.string "name", null: false
    ...
    t.text "associated_hash", limit: 16777215
    t.boolean "is_frozen", default: false
    t.float "price", default: 0.0
    t.string "owner_type"
    t.integer "owner_id"
    t.index ["is_frozen"], name: "index_billing_simulations_on_is_frozen"
    t.index ["kind"], name: "index_billing_simulations_on_kind"
    t.index ["name"], name: "index_billing_simulations_on_name"
    t.index ["owner_id"], name: "index_billing_simulations_on_owner_id"
    t.index ["owner_type"], name: "index_billing_simulations_on_owner_type"
    t.index ["period"], name: "index_billing_simulations_on_period"
  end

  create_table "billings", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.string "name", null: false
    t.integer "period", null: false
    ...
    t.string "owner_type"
    t.integer "owner_id"
    t.index ["is_frozen"], name: "index_billings_on_is_frozen"
    t.index ["kind"], name: "index_billings_on_kind"
    t.index ["name"], name: "index_billings_on_name"
    t.index ["owner_id"], name: "index_billings_on_owner_id"
    t.index ["owner_type"], name: "index_billings_on_owner_type"
    t.index ["period"], name: "index_billings_on_period"
  end

  create_table "boxes", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb3", force: :cascade do |t|
    t.datetime "created_at"
    t.datetime "updated_at"
  ...
  create_table "bridge_accounts", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci", force: :cascade do |t|
  ...
  create_table "budgea_accounts", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb3", force: :cascade do |t|
    t.string "identifier"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.integer "user_id"
  ...
  create_table "cedricom_receptions", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci", force: :cascade do |t|
    ...
    t.bigint "organization_id"
    t.integer "jedeclare_reception_id"
    t.bigint "user_id"
    t.index ["organization_id"], name: "index_cedricom_receptions_on_organization_id"
    t.index ["user_id"], name: "index_cedricom_receptions_on_user_id"
  end
  ...
  create_table "cms_images", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb3", force: :cascade do |t|
    t.datetime "created_at"
    t.datetime "updated_at"
    t.string "original_file_name"
  ...
  create_table "connectors", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb3", force: :cascade do |t|
    t.string "name"
    t.text "capabilities"
    t.text "apis"
    t.text "active_apis"
  ...
  create_table "conterpart_accounts", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.datetime "created_at"
    t.datetime "updated_at"
    t.string "name"
    t.string "number"
    ...
    t.integer "accounting_plan_id"
    t.boolean "is_default", default: false
    t.index ["accounting_plan_id"], name: "index_conterpart_accounts_on_accounting_plan_id"
    t.index ["number"], name: "index_conterpart_accounts_on_number"
    t.index ["user_id"], name: "index_conterpart_accounts_on_user_id"
  end

  create_table "counter_error_script_mailers", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.string "error_type"
  ...
  create_table "csv_descriptors", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb3", force: :cascade do |t|
    t.datetime "created_at"
    t.datetime "updated_at"
  ...
  create_table "data_flows", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.integer "period", null: false
    ...
    t.integer "bank_excess", default: 0
    t.integer "journal_excess", default: 0
    t.integer "scanned_sheets", default: 0
    t.integer "period_version", default: 0
    t.index ["period"], name: "index_data_flows_on_period"
    t.index ["period_version"], name: "index_data_flows_on_period_version"
    t.index ["user_id"], name: "index_data_flows_on_user_id"
  end

  create_table "dba_sequences", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb3", force: :cascade do |t|
  ...
  create_table "debit_mandates", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb3", force: :cascade do |t|
    t.datetime "created_at"
    t.datetime "updated_at"
  ...
  create_table "dematbox", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb3", force: :cascade do |t|
    t.datetime "created_at"
    t.datetime "updated_at"
    t.boolean "is_configured", default: false, null: false
  ...
  create_table "dematbox_services", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb3", force: :cascade do |t|
    t.datetime "created_at"
    t.datetime "updated_at"
    t.string "name"
    t.string "pid"
  ...
  create_table "dematbox_subscribed_services", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb3", force: :cascade do |t|
    t.string "mongo_id"
    t.datetime "created_at"
    t.datetime "updated_at"
    t.string "name"
  ...
  create_table "document_deliveries", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb3", force: :cascade do |t|
    t.datetime "created_at"
    t.datetime "updated_at"
    t.string "provider"
    t.date "date"
  ...
  create_table "documents", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb3", force: :cascade do |t|
    ...
    t.index ["pack_piece_id"], name: "index_documents_on_pack_piece_id"
  end

  create_table "dropbox_basics", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb3", force: :cascade do |t|
    t.string "mongo_id"
    t.datetime "created_at"
    t.datetime "updated_at"
    ...
    t.integer "external_file_storage_id"
    t.string "external_file_storage_id_mongo_id"
    t.string "encrypted_access_token"
    t.index ["external_file_storage_id"], name: "external_file_storage_id"
    t.index ["external_file_storage_id_mongo_id"], name: "external_file_storage_id_mongo_id"
    t.index ["mongo_id"], name: "index_dropbox_basics_on_mongo_id"
  end
  ...
  create_table "emails", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb3", force: :cascade do |t|
    ...
    t.string "cloud_original_content_file_name"
    t.string "cloud_original_content_content_type"
    t.integer "cloud_original_content_file_size"
    t.datetime "cloud_original_content_updated_at"
    t.string "cloud_original_content_fingerprint"
    t.integer "to_user_id"
    t.string "to_user_id_mongo_id"
    t.integer "from_user_id"
    t.string "from_user_id_mongo_id"
    t.string "message_id"
    t.index ["from_user_id"], name: "from_user_id"
    t.index ["from_user_id_mongo_id"], name: "from_user_id_mongo_id"
    t.index ["mongo_id"], name: "index_emails_on_mongo_id"
    t.index ["to_user_id"], name: "to_user_id"
    t.index ["to_user_id_mongo_id"], name: "to_user_id_mongo_id"
  end

  create_table "events", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb3", force: :cascade do |t|
    t.datetime "created_at"
    t.datetime "updated_at"
    t.string "user_code"
    t.string "action"
  ...
  create_table "exact_online", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1", force: :cascade do |t|
  ...
  create_table "exercises", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb3", force: :cascade do |t|
    t.string "mongo_id"
    t.datetime "created_at"
    t.datetime "updated_at"
    t.date "start_date"
    ...
    t.index ["mongo_id"], name: "index_exercises_on_mongo_id"
    t.index ["user_id"], name: "user_id"
    t.index ["user_id_mongo_id"], name: "user_id_mongo_id"
  end

  create_table "expense_categories", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb3", force: :cascade do |t|
    t.string "mongo_id"
    t.string "name"
    t.string "description"
    t.integer "account_book_type_id"
    t.string "account_book_type_id_mongo_id"
    t.index ["account_book_type_id"], name: "account_book_type_id"
    t.index ["account_book_type_id_mongo_id"], name: "account_book_type_id_mongo_id"
    t.index ["mongo_id"], name: "index_expense_categories_on_mongo_id"
  end

  create_table "external_file_storages", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb3", force: :cascade do |t|
    t.string "mongo_id"
    t.datetime "created_at"
    t.datetime "updated_at"
    t.string "path", default: "iDocus/:code/:year:month/:account_book/", null: false
    ...
    t.integer "user_id"
    t.string "user_id_mongo_id"
    t.index ["mongo_id"], name: "index_external_file_storages_on_mongo_id"
    t.index ["user_id"], name: "user_id"
    t.index ["user_id_mongo_id"], name: "user_id_mongo_id"
  end

  create_table "extra_orders", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.integer "period", null: false
    t.string "name"
    ...
    t.string "owner_type"
    t.string "owner_id"
    t.index ["period"], name: "index_extra_orders_on_period"
  end

  create_table "favorite_customers", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.text "customer_ids"
    t.integer "user_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["user_id"], name: "index_favorite_customers_on_user_id"
  end

  create_table "file_naming_policies", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb3", force: :cascade do |t|
    t.string "mongo_id"
    t.datetime "created_at"
    t.datetime "updated_at"
    ...
    t.integer "organization_id"
    t.string "organization_id_mongo_id"
    t.index ["mongo_id"], name: "index_file_naming_policies_on_mongo_id"
    t.index ["organization_id"], name: "organization_id"
    t.index ["organization_id_mongo_id"], name: "organization_id_mongo_id"
  end

  create_table "file_sending_kits", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb3", force: :cascade do |t|
    t.string "mongo_id"
    t.datetime "created_at"
    t.datetime "updated_at"
    ...
    t.integer "organization_id"
    t.string "organization_id_mongo_id"
    t.index ["mongo_id"], name: "index_file_sending_kits_on_mongo_id"
    t.index ["organization_id"], name: "organization_id"
    t.index ["organization_id_mongo_id"], name: "organization_id_mongo_id"
  end

  create_table "firebase_tokens", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1", force: :cascade do |t|
    t.integer "user_id"
    t.string "name"
    t.string "platform"
  ...
  create_table "ftps", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb3", force: :cascade do |t|
    t.string "mongo_id"
    t.datetime "created_at"
    t.datetime "updated_at"
    t.string "path", default: "iDocus/:code/:year:month/:account_book/", null: false
    ...
    t.index ["external_file_storage_id"], name: "external_file_storage_id"
    t.index ["external_file_storage_id_mongo_id"], name: "external_file_storage_id_mongo_id"
    t.index ["mongo_id"], name: "index_ftps_on_mongo_id"
    t.index ["organization_id"], name: "index_ftps_on_organization_id"
  end

  create_table "google_docs", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb3", force: :cascade do |t|
    t.string "mongo_id"
    t.datetime "created_at"
    t.datetime "updated_at"
    t.boolean "is_configured", default: false, null: false
    ...
    t.index ["external_file_storage_id"], name: "external_file_storage_id"
    t.index ["external_file_storage_id_mongo_id"], name: "external_file_storage_id_mongo_id"
    t.index ["mongo_id"], name: "index_google_docs_on_mongo_id"
  end
  ...
  create_table "groups", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb3", force: :cascade do |t|
    ...
    t.integer "organization_id"
    t.string "organization_id_mongo_id"
    t.index ["mongo_id"], name: "index_groups_on_mongo_id"
    t.index ["organization_id"], name: "organization_id"
    t.index ["organization_id_mongo_id"], name: "organization_id_mongo_id"
  end

  create_table "groups_members", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1", force: :cascade do |t|
  ...
  create_table "groups_users", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb3", force: :cascade do |t|
    t.integer "user_id", null: false
    t.integer "group_id", null: false
  ...
  create_table "ibizabox_folders", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb3", force: :cascade do |t|
  ...
  create_table "invoice_settings", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.bigint "organization_id"
    t.bigint "user_id"
    t.string "user_code"
  ...
  create_table "invoices", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb3", force: :cascade do |t|
    ...
    t.string "subscription_id_mongo_id"
    t.integer "period_id"
    t.string "period_id_mongo_id"
    t.integer "period_v2", default: 0, null: false
    ...
    t.index ["period_v2"], name: "index_invoices_on_period_v2"
    t.index ["subscription_id"], name: "subscription_id"
    t.index ["subscription_id_mongo_id"], name: "subscription_id_mongo_id"
    t.index ["user_id"], name: "user_id"
    t.index ["user_id_mongo_id"], name: "user_id_mongo_id"
  end

  create_table "job_processings", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.string "name"
  ...
  create_table "mcf_documents", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1", force: :cascade do |t|
    t.integer "user_id"
  ...
  create_table "mcf_settings", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1", force: :cascade do |t|
    t.integer "organization_id"
    t.string "encrypted_access_token"
    t.string "encrypted_refresh_token"
  ...
  create_table "members", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1", force: :cascade do |t|
  ...
  create_table "mobile_connexions", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1", force: :cascade do |t|
    t.integer "user_id"
    t.string "platform"
    t.string "version"
    t.integer "periode"
  ...
  create_table "notifiables_notifies", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1", force: :cascade do |t|
  ...
  create_table "notifies", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1", force: :cascade do |t|
  ...
  create_table "operations", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb3", force: :cascade do |t|
    t.string "mongo_id"
    t.datetime "created_at"
    t.datetime "updated_at"
    t.date "date"
    ...
    t.index ["mongo_id"], name: "index_operations_on_mongo_id"
    t.index ["organization_id"], name: "organization_id"
    t.index ["organization_id_mongo_id"], name: "organization_id_mongo_id"
    t.index ["pack_id"], name: "pack_id"
    ...
    t.index ["unrecognized_iban"], name: "index_operations_on_unrecognized_iban"
    t.index ["user_id"], name: "user_id"
    t.index ["user_id_mongo_id"], name: "user_id_mongo_id"
  end
  ...
  create_table "orders", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb3", force: :cascade do |t|
    ...
    t.index ["period_id"], name: "period_id"
    t.index ["period_id_mongo_id"], name: "period_id_mongo_id"
    t.index ["period_v2"], name: "index_orders_on_period_v2"
    t.index ["user_id"], name: "user_id"
    t.index ["user_id_mongo_id"], name: "user_id_mongo_id"
  end

  create_table "organization_groups", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1", force: :cascade do |t|
    t.string "name", null: false
    t.string "description"
  ...
  create_table "organization_groups_organizations", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.integer "organization_id"
    t.integer "organization_group_id"
    t.index ["organization_group_id"], name: "index_ogo_organization_group_id"
    t.index ["organization_id"], name: "index_ogo_organization_id"
  end

  create_table "organization_rights", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb3", force: :cascade do |t|
    t.string "mongo_id"
    t.datetime "created_at"
    t.datetime "updated_at"
  ...
  create_table "organizations", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb3", force: :cascade do |t|
    t.string "mongo_id"
    t.datetime "created_at"
    t.datetime "updated_at"
    t.string "name"
    ...
    t.string "cedricom_user"
    t.string "encrypted_cedricom_password"
    t.string "cedricom_name"
    t.boolean "invoice_created_customer", default: false
    t.string "jedeclare_user"
    t.string "encrypted_jedeclare_password"
    t.string "jedeclare_account_identifier"
  ...
  create_table "pack_dividers", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb3", force: :cascade do |t|
    t.string "mongo_id"
    t.datetime "created_at"
    t.datetime "updated_at"
    t.string "name"
  ...
  create_table "pack_pieces", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb3", force: :cascade do |t|
    t.string "mongo_id"
    t.datetime "created_at"
    t.datetime "updated_at"
    t.string "name"
    ...
    t.string "detected_third_party_name"
    t.string "detected_invoice_number"
    t.date "detected_invoice_date"
    t.date "detected_invoice_due_date"
    t.float "detected_invoice_amount_without_taxes"
    t.float "detected_invoice_taxes_amount"
    t.float "detected_invoice_amount_with_taxes"
  ...
  create_table "pack_report_expenses", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb3", force: :cascade do |t|
    t.string "mongo_id"
    t.datetime "created_at"
    t.datetime "updated_at"
    ...
    t.string "user_id_mongo_id"
    t.integer "report_id"
    t.string "report_id_mongo_id"
    t.integer "piece_id"
    t.string "piece_id_mongo_id"
    t.index ["mongo_id"], name: "index_pack_report_expenses_on_mongo_id"
    t.index ["organization_id"], name: "organization_id"
    t.index ["organization_id_mongo_id"], name: "organization_id_mongo_id"
    t.index ["piece_id"], name: "piece_id"
    t.index ["piece_id_mongo_id"], name: "piece_id_mongo_id"
    t.index ["report_id"], name: "report_id"
    t.index ["report_id_mongo_id"], name: "report_id_mongo_id"
    t.index ["user_id"], name: "user_id"
    t.index ["user_id_mongo_id"], name: "user_id_mongo_id"
  end

  create_table "pack_report_observation_guests", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb3", force: :cascade do |t|
    t.string "mongo_id"
    t.string "first_name"
    t.string "last_name"
    t.integer "observation_id"
    t.string "observation_id_mongo_id"
    t.index ["mongo_id"], name: "index_pack_report_observation_guests_on_mongo_id"
    t.index ["observation_id"], name: "observation_id"
    t.index ["observation_id_mongo_id"], name: "observation_id_mongo_id"
  end

  create_table "pack_report_observations", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb3", force: :cascade do |t|
    t.string "mongo_id"
    t.string "comment"
    t.integer "expense_id"
    t.string "expense_id_mongo_id"
    t.index ["expense_id"], name: "expense_id"
    t.index ["expense_id_mongo_id"], name: "expense_id_mongo_id"
    t.index ["mongo_id"], name: "index_pack_report_observations_on_mongo_id"
  end

  create_table "pack_report_preseizure_accounts", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb3", force: :cascade do |t|
    t.string "mongo_id"
    t.datetime "created_at"
    t.datetime "updated_at"
    t.integer "type"
    ...
    t.string "preseizure_id_mongo_id"
    t.index ["mongo_id"], name: "index_pack_report_preseizure_accounts_on_mongo_id"
    t.index ["preseizure_id"], name: "preseizure_id"
    t.index ["preseizure_id_mongo_id"], name: "preseizure_id_mongo_id"
  end

  create_table "pack_report_preseizure_entries", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb3", force: :cascade do |t|
    t.string "mongo_id"
    t.datetime "created_at"
    t.datetime "updated_at"
    t.integer "type"
    ...
    t.string "preseizure_id_mongo_id"
    t.integer "account_id"
    t.string "account_id_mongo_id"
    t.index ["account_id"], name: "account_id"
    t.index ["account_id_mongo_id"], name: "account_id_mongo_id"
    t.index ["mongo_id"], name: "index_pack_report_preseizure_entries_on_mongo_id"
    t.index ["preseizure_id"], name: "preseizure_id"
    t.index ["preseizure_id_mongo_id"], name: "preseizure_id_mongo_id"
  end

  create_table "pack_report_preseizures", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb3", force: :cascade do |t|
    t.string "mongo_id"
    t.datetime "created_at"
    t.datetime "updated_at"
    t.string "type"
    ...
    t.string "export_state", default: "not_configured"
    t.string "delivery_state", default: "not_configured"
    ...
    t.string "operation_id_mongo_id"
    ...
    t.index ["delivery_state"], name: "index_pack_report_preseizures_on_delivery_state"
    t.index ["duplicate_unblocked_by_user_id"], name: "index_pack_report_preseizures_on_duplicate_unblocked_by_user_id"
    t.index ["export_state"], name: "index_pack_report_preseizures_on_export_state"
    ...
    t.index ["updated_at"], name: "index_pack_report_preseizures_on_updated_at"
    t.index ["user_id"], name: "user_id"
  end

  create_table "pack_report_preseizures_backup", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb3", force: :cascade do |t|
    t.string "mongo_id"
    t.datetime "created_at"
    t.datetime "updated_at"
    t.string "type"
  ...
  create_table "pack_report_preseizures_pre_assignment_deliveries", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb3", force: :cascade do |t|
    t.integer "pre_assignment_delivery_id"
    t.integer "preseizure_id"
    t.index ["pre_assignment_delivery_id"], name: "index_prppad_pre_assignment_delivery_id"
    t.index ["preseizure_id"], name: "index_prppad_preseizure_id"
  end

  create_table "pack_report_preseizures_pre_assignment_exports", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1", force: :cascade do |t|
    t.integer "preseizure_id"
    t.integer "pre_assignment_export_id"
    t.index ["pre_assignment_export_id"], name: "index_prppae_pre_assignment_export_id"
    t.index ["preseizure_id"], name: "index_prppae_preseizure_id"
  end

  create_table "pack_report_preseizures_remote_files", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb3", force: :cascade do |t|
    t.integer "remote_file_id"
    t.integer "pack_report_preseizure_id"
    t.index ["pack_report_preseizure_id"], name: "index_prprf_pack_report_preseizure_id"
    t.index ["remote_file_id"], name: "index_prprf_remote_file_id"
  end

  create_table "pack_report_temp_preseizures", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.integer "position"
    t.boolean "is_made_by_abbyy", default: false, null: false
    t.integer "organization_id"
    t.integer "user_id"
    ...
    t.text "raw_preseizure", limit: 4294967295
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["operation_id"], name: "index_pack_report_temp_preseizures_on_operation_id"
    t.index ["organization_id"], name: "index_pack_report_temp_preseizures_on_organization_id"
    t.index ["piece_id"], name: "index_pack_report_temp_preseizures_on_piece_id"
    t.index ["position"], name: "index_pack_report_temp_preseizures_on_position"
    t.index ["report_id"], name: "index_pack_report_temp_preseizures_on_report_id"
    t.index ["user_id"], name: "index_pack_report_temp_preseizures_on_user_id"
  end

  create_table "pack_reports", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb3", force: :cascade do |t|
    t.string "mongo_id"
    t.datetime "created_at"
    t.datetime "updated_at"
    t.string "name"
    ...
    t.string "document_id_mongo_id"
    t.index ["document_id"], name: "document_id"
    t.index ["document_id_mongo_id"], name: "document_id_mongo_id"
    t.index ["mongo_id"], name: "index_pack_reports_on_mongo_id"
    t.index ["organization_id"], name: "organization_id"
    t.index ["organization_id_mongo_id"], name: "organization_id_mongo_id"
    t.index ["pack_id"], name: "pack_id"
    t.index ["pack_id_mongo_id"], name: "pack_id_mongo_id"
  ...
  create_table "pack_reports_backup", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb3", force: :cascade do |t|
    t.string "mongo_id"
    t.datetime "created_at"
    t.datetime "updated_at"
    t.string "name"
  ...
  create_table "packs", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb3", force: :cascade do |t|
    t.string "mongo_id"
    t.datetime "created_at"
    t.datetime "updated_at"
    t.datetime "locked_at"
    ...
    t.index ["owner_id_mongo_id"], name: "owner_id_mongo_id"
  end

  create_table "paper_processes", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb3", force: :cascade do |t|
    t.string "mongo_id"
    t.datetime "created_at"
    t.datetime "updated_at"
    t.string "type"
    ...
    t.string "period_document_id_mongo_id"
    t.integer "order_id"
    t.index ["mongo_id"], name: "index_paper_processes_on_mongo_id"
    t.index ["order_id"], name: "index_paper_processes_on_order_id"
    t.index ["organization_id"], name: "organization_id"
    t.index ["organization_id_mongo_id"], name: "organization_id_mongo_id"
    t.index ["period_document_id"], name: "period_document_id"
    t.index ["period_document_id_mongo_id"], name: "period_document_id_mongo_id"
    t.index ["user_id"], name: "user_id"
    t.index ["user_id_mongo_id"], name: "user_id_mongo_id"
  end

  create_table "period_billings", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb3", force: :cascade do |t|
    t.string "mongo_id"
    ...
    t.integer "period_id"
    t.string "period_id_mongo_id"
    t.index ["mongo_id"], name: "index_period_billings_on_mongo_id"
    t.index ["period_id"], name: "period_id"
    t.index ["period_id_mongo_id"], name: "period_id_mongo_id"
  end

  create_table "period_deliveries", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb3", force: :cascade do |t|
    t.string "mongo_id"
    t.datetime "created_at"
    t.datetime "updated_at"
    ...
    t.integer "period_id"
    t.string "period_id_mongo_id"
    t.index ["mongo_id"], name: "index_period_deliveries_on_mongo_id"
    t.index ["period_id"], name: "period_id"
    t.index ["period_id_mongo_id"], name: "period_id_mongo_id"
  end

  create_table "period_documents", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb3", force: :cascade do |t|
    t.string "mongo_id"
    t.datetime "created_at"
    t.datetime "updated_at"
    ...
    t.string "pack_id_mongo_id"
    t.integer "period_v2", default: 0, null: false
    t.integer "preseizures_pieces", default: 0
    t.integer "expenses_pieces", default: 0
    t.integer "preseizures_operations", default: 0
    t.index ["mongo_id"], name: "index_period_documents_on_mongo_id"
    t.index ["organization_id"], name: "organization_id"
    t.index ["organization_id_mongo_id"], name: "organization_id_mongo_id"
    t.index ["pack_id"], name: "pack_id"
    t.index ["pack_id_mongo_id"], name: "pack_id_mongo_id"
    t.index ["period_id"], name: "period_id"
    t.index ["period_id_mongo_id"], name: "period_id_mongo_id"
    t.index ["period_v2"], name: "index_period_documents_on_period_v2"
    t.index ["user_id"], name: "user_id"
    t.index ["user_id_mongo_id"], name: "user_id_mongo_id"
  end

  create_table "periods", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb3", force: :cascade do |t|
    t.string "mongo_id"
    t.datetime "created_at"
    t.datetime "updated_at"
    t.datetime "locked_at"
    ...
    t.integer "basic_excess", default: 0
    t.integer "basic_total_compta_piece", default: 0
    t.integer "plus_micro_excess", default: 0
    t.integer "plus_micro_total_compta_piece", default: 0
    t.index ["mongo_id"], name: "index_periods_on_mongo_id"
    t.index ["organization_id"], name: "organization_id"
    t.index ["organization_id_mongo_id"], name: "organization_id_mongo_id"
    t.index ["subscription_id"], name: "subscription_id"
    t.index ["subscription_id_mongo_id"], name: "subscription_id_mongo_id"
  ...
  create_table "pre_assignment_deliveries", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb3", force: :cascade do |t|
    t.datetime "created_at"
    t.datetime "updated_at"
    t.string "pack_name"
    t.string "state"
  ...
  create_table "pre_assignment_exports", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1", force: :cascade do |t|
    t.string "state"
    t.string "pack_name"
    t.string "for"
    t.string "file_name"
  ...
  create_table "product_option_orders", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb3", force: :cascade do |t|
    t.string "mongo_id"
    t.string "name"
    t.string "title"
    ...
    t.string "product_optionable_id_mongo_id"
    t.index ["mongo_id"], name: "index_product_option_orders_on_mongo_id"
    t.index ["product_optionable_id"], name: "product_optionable_id"
    t.index ["product_optionable_id_mongo_id"], name: "product_optionable_id_mongo_id"
    t.index ["product_optionable_type"], name: "product_optionable_type"
  end

  create_table "reminder_emails", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb3", force: :cascade do |t|
    t.string "mongo_id"
    t.datetime "created_at"
    t.datetime "updated_at"
    t.string "name"
    ...
    t.integer "organization_id"
    t.string "organization_id_mongo_id"
    t.index ["mongo_id"], name: "index_reminder_emails_on_mongo_id"
    t.index ["organization_id"], name: "organization_id"
    t.index ["organization_id_mongo_id"], name: "organization_id_mongo_id"
  end

  create_table "remote_files", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb3", force: :cascade do |t|
    t.string "mongo_id"
    t.datetime "created_at"
    t.datetime "updated_at"
    ...
    t.string "organization_id_mongo_id"
    t.integer "group_id"
    t.string "group_id_mongo_id"
    t.integer "remotable_id"
    t.string "remotable_id_mongo_id"
    t.index ["extension"], name: "index_remote_files_on_extension"
    t.index ["group_id"], name: "group_id"
    t.index ["group_id_mongo_id"], name: "group_id_mongo_id"
    t.index ["mongo_id"], name: "index_remote_files_on_mongo_id"
    t.index ["organization_id"], name: "organization_id"
    t.index ["organization_id_mongo_id"], name: "organization_id_mongo_id"
    t.index ["pack_id"], name: "pack_id"
    t.index ["pack_id_mongo_id"], name: "pack_id_mongo_id"
    t.index ["remotable_id"], name: "remotable_id"
    t.index ["remotable_id_mongo_id"], name: "remotable_id_mongo_id"
  ...
  create_table "retrieved_data", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb3", force: :cascade do |t|
    t.text "state"
  ...
  create_table "retrievers", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb3", force: :cascade do |t|
    t.integer "budgea_id"
    t.string "name"
  ...
  create_table "sandbox_bank_accounts", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb3", force: :cascade do |t|
    t.string "api_id"
    t.string "api_name", default: "budgea"
    t.string "bank_name"
    t.string "name"
  ...
  create_table "sandbox_documents", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb3", force: :cascade do |t|
    t.string "api_id"
    t.string "api_name", default: "budgea"
  ...
  create_table "sandbox_operations", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb3", force: :cascade do |t|
    t.string "api_id"
    t.string "api_name", default: "budgea"
    t.date "date"
    t.date "value_date"
  ...
  create_table "scanning_providers", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb3", force: :cascade do |t|
    t.string "mongo_id"
    t.datetime "created_at"
    t.datetime "updated_at"
    t.string "name"
  ...
  create_table "sftps", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.string "path", default: "iDocus/:code/:year:month/:account_book/", null: false
    t.boolean "is_configured", default: false, null: false
    t.datetime "error_fetched_at"
    t.text "error_message", limit: 4294967295
  ...
  create_table "software_acds", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.string "code"
    t.string "username"
    t.string "encrypted_password"
    t.string "owner_type"
    ...
    t.datetime "updated_at", null: false
    t.string "url"
    t.index ["owner_type", "owner_id"], name: "index_software_acds_on_owner_type_and_owner_id"
  end

  create_table "software_cegids", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.boolean "is_used"
  ...
  create_table "software_ciels", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.boolean "is_used"
    t.integer "auto_deliver", default: -1
    t.string "owner_type"
    t.bigint "owner_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["is_used"], name: "index_software_ciels_on_is_used"
    t.index ["owner_type", "owner_id"], name: "index_software_ciels_on_owner_type_and_owner_id"
  end

  create_table "software_coalas", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.boolean "is_used"
    t.integer "auto_deliver", default: -1
    t.string "owner_type"
    t.bigint "owner_id"
  ...
  create_table "software_cogilogs", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.boolean "is_used"
    t.integer "auto_deliver", default: -1
    t.integer "owner_id"
    t.string "owner_type"
  ...
  create_table "software_csv_descriptors", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.boolean "is_used"
    t.integer "auto_deliver", default: -1
    t.string "owner_type"
    t.bigint "owner_id"
  ...
  create_table "software_exact_online", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.text "encrypted_client_id"
    t.text "encrypted_client_secret"
    t.string "user_name"
    t.string "full_name"
  ...
  create_table "software_fec_agiris", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.boolean "is_used"
    t.integer "auto_deliver", default: -1
    t.string "owner_type"
    t.bigint "owner_id"
  ...
  create_table "software_ibizas", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.string "state"
    t.string "state_2"
    t.text "description"
  ...
  create_table "software_my_unisofts", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci", force: :cascade do |t|
  ...
  create_table "software_quadratus", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.boolean "is_used"
    t.integer "auto_deliver", default: -1
    t.string "owner_type"
    t.bigint "owner_id"
  ...
  create_table "software_sage_gecs", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["owner_type", "owner_id"], name: "index_software_sage_gecs_on_owner_type_and_owner_id"
  end

  create_table "softwares_settings", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb3", force: :cascade do |t|
    t.integer "user_id"
  ...
  create_table "staffing_flows", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.datetime "created_at"
    t.datetime "updated_at"
    t.string "kind"
    t.text "params", limit: 4294967295
  ...
  create_table "statistics", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb3", force: :cascade do |t|
    t.datetime "created_at"
    t.datetime "updated_at"
  ...
  create_table "subscription_options", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb3", force: :cascade do |t|
    t.string "mongo_id"
    t.datetime "created_at"
    t.datetime "updated_at"
    t.string "name"
  ...
  create_table "subscription_options_subscriptions", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb3", force: :cascade do |t|
    t.integer "subscription_id"
    t.integer "subscription_option_id"
    t.index ["subscription_id"], name: "index_sos_subscription_id"
    t.index ["subscription_option_id"], name: "index_sos_subscription_option_id"
  end
  ...
  create_table "subscriptions", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb3", force: :cascade do |t|
    t.string "mongo_id"
    t.datetime "created_at"
    t.datetime "updated_at"
    t.integer "period_duration", default: 1, null: false
  ...
  create_table "temp_documents", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb3", force: :cascade do |t|
    t.string "mongo_id"
    t.datetime "created_at"
    t.datetime "updated_at"
    t.string "original_file_name"
  ...
  create_table "temp_packs", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb3", force: :cascade do |t|
    t.string "mongo_id"
    t.datetime "created_at"
    t.datetime "updated_at"
    t.datetime "locked_at"
  ...
  create_table "user_options", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb3", force: :cascade do |t|
    t.string "mongo_id"
    t.datetime "created_at"
    t.datetime "updated_at"
    t.datetime "locked_at"
  ...
  create_table "user_packages", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.string "name", null: false
    t.integer "period", null: false
    ...
    t.integer "journal_size", default: 5, null: false
    t.boolean "is_active", default: true, null: false
    t.index ["name"], name: "index_user_packages_on_name"
    t.index ["period"], name: "index_user_packages_on_period"
    t.index ["user_id"], name: "index_user_packages_on_user_id"
    t.index ["version"], name: "index_user_packages_on_version"
  end
  ...
  create_table "users", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb3", force: :cascade do |t|
    ...
    t.string "legal_registration_city"
    t.string "registration_number"
    t.string "address_street"
    t.string "address_zip_code"
    t.string "address_city"
    t.string "cedricom_account_identifier"
    t.string "jedeclare_account_identifier"
    t.boolean "full_access", default: true
    t.integer "manager_id"
    t.integer "parent_id"
    t.boolean "display_period_upload", default: false
